#ifndef PYBIND_CPP_W_PYTHON_EXAMPLE_MATPLOTLIBCPP_H
#define PYBIND_CPP_W_PYTHON_EXAMPLE_MATPLOTLIBCPP_H
...
struct _interpreter {
 ...
 private:
  char* old_python_launcher = nullptr;
  char* old_python_home = nullptr;
  char* old_python_path = nullptr;
...
//    std::string python_home{CPP_PYTHON_HOME};
//    std::wstring w_python_home{python_home.begin(), python_home.end()};
//    Py_SetPythonHome(w_python_home.c_str());
//    std::string python_path{CPP_PYTHON_PATH};
//    std::wstring w_python_path{python_path.begin(), python_path.end()};
//    Py_SetPath(w_python_path.c_str());
    old_python_launcher = getenv("__PYVENV_LAUNCHER__");
    old_python_home = getenv("PYTHONHOME");
...
#endif  // PYBIND_CPP_W_PYTHON_EXAMPLE_MATPLOTLIBCPP_H
